...
- **5D — full interface:** inventory, character sheet, map, journal, and codex overlays, settings, help, keyboard rebinding, the accessibility pass, contextual onboarding, and the Living Tapestry art pass. Exit demonstration: every screen and overlay operates by keyboard with the completed accessibility and art passes.
