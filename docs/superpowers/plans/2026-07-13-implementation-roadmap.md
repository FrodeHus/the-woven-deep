...
**5D-1 design:** `docs/superpowers/specs/2026-07-17-guest-interface-design.md` (with its two dated amendments)
...
**5D-2 (next):** the remaining 5D scope — contextual onboarding, the accessibility pass, the Living Tapestry art pass, and the lighting/atmosphere work — layered on this functional interface.
