...
export default tseslint.config(
  ...
  },
  {
    ...
    rules: {
      ...
      // Compiler-era react-hooks rules that flag patterns still present in the web client; keep
      // them visible as warnings until the affected components are refactored.
