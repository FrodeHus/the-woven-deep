  ...
  "flex flex-col gap-4 border-line bg-surface p-6 text-fg shadow-lg outline-none transition-transform duration-300 ease-in-out",
  {
    variants: {
      side: {
        ...
        bottom: "w-full border-t data-starting-style:translate-y-full data-ending-style:translate-y-full",
        left: "h-full w-3/4 border-r data-starting-style:-translate-x-full data-ending-style:-translate-x-full sm:max-w-sm",
        right: "h-full w-3/4 border-l data-starting-style:translate-x-full data-ending-style:translate-x-full sm:max-w-sm",
      },
    },
    defaultVariants: { side: "right" },
  }
