...
export const merchantPopulationV7 = z.strictObject({ ...merchantPopulationFields, departureAt: safeNonNegative });
export const merchantPopulation = z.strictObject({ ...merchantPopulationFields, departureAt: safeNonNegative.nullable() });
