...
function scroll(spellId: string): string {
  return `{kind: item, id: item.test-scroll, name: Test scroll, glyph: "?", color: "#e37b46", tags: [scroll], minDepth: 1, maxDepth: 20, category: scroll, stackLimit: 3, price: 15, rarity: uncommon, actionCost: 100, spellId: ${spellId}, equipment: null, combat: null, light: null, artifact: null, identification: {mode: known, poolId: null}, effects: [{effectId: effect.item.consume, parameters: {quantity: 1}}]}`;
}
