...
function tomeItem(spellId: string): string {
  return `{kind: item, id: item.test-tome, name: Test tome, glyph: "?", color: "#e37b46", tags: [scroll], minDepth: 1, maxDepth: 20, category: scroll, stackLimit: 3, price: 15, rarity: uncommon, actionCost: 100, equipment: null, combat: null, light: null, identification: {mode: known, poolId: null}, effects: [{effectId: effect.spell.learn, parameters: {spellId: ${spellId}}, requiresLivingTarget: false}]}`;
}

const filler =
  '{kind: item, id: item.test-filler, name: Test filler, glyph: "?", color: "#e37b46", tags: [scroll], minDepth: 1, maxDepth: 20, category: scroll, stackLimit: 3, price: 15, rarity: uncommon, actionCost: 100, equipment: null, combat: null, light: null, identification: {mode: known, poolId: null}, effects: []}';
